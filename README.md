...
📍 **Germany** | ☁️ **Senior YAML engineer** | 🤖 **AI tooling tinkerer**
...
![Codex](https://custom-icon-badges.demolab.com/badge/-Codex-412991?style=flat-square&logo=openai&logoColor=white)
![OpenClaw](https://img.shields.io/badge/-OpenClaw-FF6B35?style=flat-square&logoColor=white)

> Trying to build stuff that doesn't require emotional support
...
- 😤 **[anger-bash](https://github.com/stearz/anger-bash)** — terminal-based anger management; obviously critical infrastructure

## Forks & Contributions

- 🤖 **[kelos](https://github.com/kelos-dev/kelos)** — Kubernetes-native framework for orchestrating AI coding agents
  - *contributed: Helm chart distribution via ghcr OCI registry + Homebrew tap*
- 📟 **[Nagstamon](https://github.com/HenriWahl/Nagstamon)** — Nagios status monitor for your desktop
  - *contributed: support for Prometheus and Alertmanager*
...
| --------------- | --------------------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Dec 7–10        | [IT Tage *(upcoming)*](https://www.ittage.informatik-aktuell.de/programm) | Frankfurt          | Fehler managen – Der Weg zur evolutionären IT                                                                                                                          |
| Sep 16–17       | [TACON *(upcoming)*](https://events.summit-community.de/event/tacon-2026/agenda/) | Leipzig            | Kubernetes-Workloads unter Last: Tools, Herausforderungen und Best Practices                                                                                            |
| May 19–22       | [CloudLand](https://meine.doag.org/events/cloudland/2026/agenda/#agendaId.7205) | Heide Park Soltau | [Performance Testing Kubernetes Workloads](https://github.com/stearz/slides/blob/main/2026%20-%20CloudLand%20-%20Performance%20testing%20Kubernetes-Workloads%20-%20GERMAN.pdf) |

### 2025

| Date            | Event                       | Location          | Topic                                                                                                                                                                  |
| --------------- | --------------------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Dec 8–11        | [IT Tage](https://www.ittage.informatik-aktuell.de/konferenz/it-tage-2025/programm-2025.html) | Frankfurt         | [Lasttests für Kubernetes-Workloads](https://github.com/stearz/slides/blob/main/2025%20-%20IT-Tage%20-%20Lasttests%20f%C3%BCr%20Kubernetes-Workloads%20-%20GERMAN.pdf) |

## Latest Posts

<!-- BLOG-POST-LIST:START -->
- [Do you, too, let your customers test your app’s performance?](https://medium.com/@stearz/do-you-too-let-your-customers-test-your-apps-performance-463465f03d2b?source=rss-95df8f367297------2)
- [The boring truth about AI in software engineering](https://medium.com/@stearz/yet-another-lurid-but-boring-article-about-ai-55f0a47b2a83?source=rss-95df8f367297------2)
...
[![Mastodon](https://img.shields.io/badge/-@StephanSchwarz-6364FF?style=flat-square&logo=mastodon&logoColor=white)](https://nrw.social/@StephanSchwarz)
[![Sessionize](https://img.shields.io/badge/-stearz__net-1AB394?style=flat-square&logo=sessionize&logoColor=white)](https://sessionize.com/stearz_net/)
[![Medium](https://img.shields.io/badge/-@stearz-000000?style=flat-square&logo=medium&logoColor=white)](https://medium.com/@stearz)

---

*Boring infrastructure is underrated | Good platforms serve people - not the other way around*
